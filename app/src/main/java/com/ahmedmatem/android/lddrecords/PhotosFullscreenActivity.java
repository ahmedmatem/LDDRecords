...
public class PhotosFullscreenActivity extends AppCompatActivity
        implements PhotoFragment.OnFullScreenListener {
...
//            mControlsView.setVisibility(View.VISIBLE);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null && bundle.containsKey(RECORD_EXTRA)) {
            mRecord = bundle.getParcelable(RECORD_EXTRA);
        }

        mVisible = true;
//        mControlsView = findViewById(R.id.fullscreen_content_controls);
        mContentView = findViewById(R.id.pager_container);

        List<Picture> pictures = null;
        if (mRecord != null) {
            pictures = mRecord.getPictures();
        }
        mSectionsPagerAdapter = new SectionsPagerAdapter(getSupportFragmentManager(), pictures);
...
//        mControlsView.setOnTouchListenertVisibility(View.GONE);
        mVisible = false;
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public SectionsPagerAdapter(FragmentManager fm, List<Picture> pictures) {
            super(fm);
            mPictures = pictures;
        }
        ...
        public Fragment getItem(int position) {
            return PhotoFragment.newInstance(mPictures.get(position).getPath());
        }
